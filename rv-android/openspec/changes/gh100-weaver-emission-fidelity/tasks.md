...
- [ ] 4.4 Record in this file which commit carries the red evidence, so the repair commits can reference it (INV-INS-108) — filled in by the first repair commit, since the hash does not exist until the red evidence is committed
