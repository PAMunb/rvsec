...
| Event Granularity of unique_msg (modified) / INV-CORE-25, INV-CORE-63 | `rv_android_core/domain/log.py:157-160` | `test_log.py::test_evidence_keys_do_not_split_the_identity`, `::test_a_message_without_evidence_yields_a_byte_identical_key`, `::test_a_non_envelope_message_is_its_own_identity_message`, `::test_evidence_fields_stay_out_of_identity_and_written_schema` |
