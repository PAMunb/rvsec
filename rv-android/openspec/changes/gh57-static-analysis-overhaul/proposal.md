...
10. **Codex pre-sweep correctness fixes** (independent code review 2026-05-15, four small targeted defects landed before the 380-APK sweep so the sweep validates the corrected pipeline):
