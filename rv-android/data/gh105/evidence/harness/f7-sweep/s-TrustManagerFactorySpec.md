...
|---|---|---|---|
| `TrustManagerFactorySpec-d15-sunx509.txt` | moved | init:TRUSTMANAGERFACTORY-ALG-00, init:TRUSTMANAGERFACTORY-ORDER-00 | init:TRUSTMANAGERFACTORY-NOBS-00, init:TRUSTMANAGERFACTORY-ORDER-00 |
| `TrustManagerFactorySpec-guard-on-field.txt` | moved | init:TRUSTMANAGERFACTORY-ORDER-00 | init:TRUSTMANAGERFACTORY-NOBS-00, init:TRUSTMANAGERFACTORY-ORDER-00 |
| `TrustManagerFactorySpec-loaded-keystore.txt` | unchanged | — | — |
| `TrustManagerFactorySpec-managers-taken-twice.txt` | introduced | — | gtm1:TRUSTMANAGERFACTORY-ORDER-00 |
| `TrustManagerFactorySpec-pkix-init.txt` | introduced | — | init:TRUSTMANAGERFACTORY-NOBS-00 |
| `TrustManagerFactorySpec-sunx509-no-init.txt` | removed | g3:TRUSTMANAGERFACTORY-ORDER-00 | — |
| `TrustManagerFactorySpec-sunx509.txt` | moved | g3:TRUSTMANAGERFACTORY-ORDER-00, init:TRUSTMANAGERFACTORY-ALG-00, init:TRUSTMANAGERFACTORY-ORDER-00 | init:TRUSTMANAGERFACTORY-NOBS-00 |
| `TrustManagerFactorySpec-unloaded-keystore.txt` | introduced | — | init:TRUSTMANAGERFACTORY-NOBS-00 |
| `TrustManagerFactorySpec-x509.txt` | introduced | — | init:TRUSTMANAGERFACTORY-NOBS-00 |
| `TrustManagerFactorySpec.txt` | introduced | — | init:TRUSTMANAGERFACTORY-NOBS-00 |
...
- `TrustManagerFactorySpec-d15-sunx509.txt` (A) `spec=TrustManagerFactorySpec,ev=init,type=UnsafeAlgorithm,msg=v=1 code=TRUSTMANAGERFACTORY-ALG-00 ev=init obj=TrustManagerFactory val='SunX509' exp='PKIX' msg='expecting one of PKIX but found SunX509'`
