...
|---|---|---|---|
| `CipherSpec-guard-on-field.txt` | unchanged | CipherSpec.i1, CipherSpec.i2 | CipherSpec.i1, CipherSpec.i2 |
| `CipherSpec-keygen-key-mismatch.txt` | unchanged | CipherSpec.i2 | CipherSpec.i2 |
| `CipherSpec-keygen-key.txt` | unchanged | — | — |
| `CipherSpec-keystore-key.txt` | unchanged | — | — |
| `CipherSpec-nofinal-arg.txt` | unchanged | CipherSpec.i2, CipherSpec.f1 | CipherSpec.i2, CipherSpec.f1 |
| `CipherSpec-unsafe.txt` | unchanged | CipherSpec.i2, CipherSpec.f2 | CipherSpec.i2, CipherSpec.f2 |
| `CipherSpec-update-chain.txt` | unchanged | CipherSpec.i2 | CipherSpec.i2 |
| `CipherSpec.txt` | unchanged | CipherSpec.i2 | CipherSpec.i2 |
...
- `CipherSpec-unsafe.txt` (A) `spec=CipherSpec,ev=f2,type=InvalidSequenceOfMethodCalls,msg=v=1 code=CIPHER-ORDER-00 ev=i2 obj=Cipher val='' exp='' msg='the observed call sequence is not one CipherSpec accepts'`
