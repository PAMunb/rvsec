...
class StateConverter:
    ...
    def uiautomator_to_droidbot(self, ui_state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            converted = {
                ...
                "hierarchy": ui_state.get("xml", ""),  # Keep hierarchy for compatibility
            ...
            converted["_conversion_metadata"] = {
                ...
                "converted_fields": ["xml->hierarchy", "current_activity->activity", "current_package->package_name"],
                "preserved_fields": preserved_count
            }
            
            self.logger.debug(f"State conversion completed: {len(converted)} fields in result")
            return converted
    ...
    def compute_screen_hash(self, state: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            ...
            package = state.get("package_name") or state.get("current_package", "unknown")
