...
from ..constants import DEFAULT_CONNECTION_TIMEOUT, DEFAULT_ADB_SERVER_PORT
...
class DeviceManager:
    ...
    def __init__(self):
        ...
        self.logger = logging_manager.get_logger(
            "rv_uiautomator.utils.device_manager",
            {CONTEXT_COMPONENT: "DeviceManager"}
        )
