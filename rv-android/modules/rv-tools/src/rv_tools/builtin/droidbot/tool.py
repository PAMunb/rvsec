...
class DroidBotTool(AbstractTool):
    ...
    def __init__(self):
        ...
        self.logger.info(
            "Initialized DroidBot tool for lightweight test input generation"
        )
    ...
    @ErrorHandler.handle_errors(
        component="DroidBotTool", phase="execute_tool_specific_logic", reraise=True
    )
    def execute_tool_specific_logic(self, task: Task, app: App) -> None:
        ...
        with open(task.result.trace_file, "wb") as trace_file:
            ...
            self._execute_and_check_command(
                droidbot_cmd, stdout=trace_file, stderr=trace_file
            )
    ...
    def _build_droidbot_command(self, app: App, timeout_seconds: int) -> Command:
        ...
        Command format: droidbot -d <device_serial> -a <apk> -policy <policy> -count 10000000000 -timeout <timeout> -ignore_ad -is_emulator
