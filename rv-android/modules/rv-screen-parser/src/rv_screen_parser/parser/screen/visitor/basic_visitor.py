...
class BasicTextVisitor(AbstractScreenVisitor):
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="initialization"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="screen_description_generation"
    )
    def get_screen_description(self) -> ScreenDescription:
        ...
        self.logger.debug(
            f"Generated compact screen description with {len(self.items)} items"
        )

        return ScreenDescription(self.activity, self.items)

    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="node_processing"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="leaf_node_processing"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="button_processing"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="edit_text_processing"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="text_view_processing"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="checkbox_processing"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="checked_text_processing"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="image_button_processing"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="image_processing"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="toggle_button_processing"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="switch_processing"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="radio_button_processing"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="spinner_processing"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="radio_group_processing"
    )
    ...
    @ErrorHandler.handle_errors(
        component="BasicTextVisitor", operation="slider_processing"
    )
