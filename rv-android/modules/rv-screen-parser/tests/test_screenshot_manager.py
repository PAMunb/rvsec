...
class TestScreenshotManager:
    ...
    def test_save_screenshot_with_activity_name(self):
        ...
        result_path = self.manager.save_screenshot(pil_img, activity_name="MainActivity")
    ...
    def test_rename_with_state(self):
        ...
        new_path = self.manager.rename_with_state(original_path, "state_fingerprint_12345")
    ...
    def test_rename_with_state_invalid_path(self):
        ...
        result = self.manager.rename_with_state("/non/existent/path", "state_fingerprint")
