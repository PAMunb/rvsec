...
from rv_android_core.llm.evaluator.evaluator import LLMEvaluator
from rv_android_core.llm.evaluator.config import DEFAULT_PROMPTS_DIR
...
def print_evaluation_plan() -> None:
    ...
    from rv_android_core.llm.evaluator.config import (
