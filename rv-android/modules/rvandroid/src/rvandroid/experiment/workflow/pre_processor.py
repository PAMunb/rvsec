...
from rv_monitor_generator.rvsec import RVSec
from rv_android_core.experiment.event.bus import EventBus, EventType
from rv_android_core.rvandroid import RvAndroid
...
class PreProcessor:
    ...
    def _instrument_apks(self):
        ...
        with self.logger.with_context(phase="instrument_apks"):
            ...
            rvandroid = RvAndroid()
            rv_android_core.instrument_apks(results_dir=INSTRUMENTED_DIR)
