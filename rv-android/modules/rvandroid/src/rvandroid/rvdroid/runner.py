...
from rv_android_core.rvdroid.core.config import Config, ConfigKey
from rv_android_core.rvdroid.core.coordinator import TestingCoordinator
from rv_android_core.rvdroid.core.registry import get_registry
from rv_android_core.rvdroid.memory.manager import MemoryManager
from rv_android_core.rvdroid.patterns.registry import PatternRegistry
from rv_android_core.rvdroid.strategy.manager import StrategyManager
...
class RVDroidRunner:
    ...
    def _create_llm_service(self) -> Optional[Any]:
        ...
        try:
            ...
            from rv_android_core.llm.language_model import LanguageModel
