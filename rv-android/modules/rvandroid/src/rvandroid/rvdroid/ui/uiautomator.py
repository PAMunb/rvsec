...
from rv_android_core.parser.screen.visitor.model import ScreenDescription
...
from rv_android_core.util.exceptions import ADBError
...
class UIAutomator2Adapter(UIAdapter):
    ...
    def _initialize_screenshot_manager(self) -> Optional[Any]:
        ...
        """
        try:
            from rv_android_core.analysis.screenshot.screenshot_manager import ScreenshotManager
