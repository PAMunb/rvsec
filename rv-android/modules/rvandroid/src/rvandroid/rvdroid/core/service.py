...
from rv_android_core.rvdroid.analysis.context.context_analyzer import ContextAnalyzer
from rv_android_core.rvdroid.analysis.opportunity.opportunity_detector import OpportunityDetector
from rv_android_core.rvdroid.analysis.progress.progress_tracker import ProgressTracker
from rv_android_core.rvdroid.analysis.state_analyzer import StateAnalyzer
from rv_android_core.rvdroid.core.action_manager import ActionManager
from rv_android_core.rvdroid.core.llm_consultation_manager import LLMConsultationManager
from rv_android_core.rvdroid.core.state_manager import StateManager
...
from rv_android_core.rvdroid.orchestration.recovery import RecoveryManager
...
class RVDroidService(Generic[T]):
    ...
    def __init__(self, static_data: Optional[StaticAnalysisData] = None,
        ...
        import rv_android_core.rvdroid.strategy.basic_strategies
        import rv_android_core.rvdroid.strategy.visual_aware_strategy
        import rv_android_core.rvdroid.strategy.advanced_strategies
        import rv_android_core.rvdroid.strategy.adaptive_strategies
    ...
    def _setup_recovery_strategies(self) -> None:
        ...
        from rv_android_core.rvdroid.orchestration.recovery import RecoveryStrategy
