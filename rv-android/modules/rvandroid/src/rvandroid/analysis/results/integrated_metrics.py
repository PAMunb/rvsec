...
from rv_android_core.analysis.results.analysis import CoverageMetrics, ErrorMetrics, PerformanceMetrics
...
class IntegratedMetricsCalculator:
    ...
    def set_static_data(self, static_data: StaticAnalysisData) -> None:
        ...
        if static_data:
            ...
            wtg_count = len(static_data.wtg.transitions) if (
                        static_data.wtg and hasattr(static_data.wtg, 'transitions')) else 0
