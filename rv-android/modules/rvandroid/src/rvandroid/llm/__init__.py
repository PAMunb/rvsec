...
from rv_android_core.llm.data_structures import LLMMessage, LLMRole
...
def register_models():
    ...
    from rv_android_core.llm.ollama_llm import register as register_ollama
    from rv_android_core.llm.huggingface_llm import register as register_huggingface
