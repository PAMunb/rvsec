...
from rv_android_core.parser.screen.visitor.model import ScreenDescription, ItemAction
...
class StateEnricher:
    ...
    def __init__(
        ...
        try:
            from rv_android_core.parser.screen.parser_factory import ParserFactory, ParserType
