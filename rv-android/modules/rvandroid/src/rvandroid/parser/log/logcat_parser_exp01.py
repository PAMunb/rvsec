...
from rv_android_core.domain.log import RvErrorLog, RvCoverageLog
...
def parse_logcat_file_legacy_format(log_file: str):
    ...
    from rv_android_core.parser.log.logcat_parser_exp01_legacy import parse_logcat_file as legacy_parse
