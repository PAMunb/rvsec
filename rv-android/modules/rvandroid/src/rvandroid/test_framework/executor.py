...
from rv_android_core.analysis.results.integrated_metrics import IntegratedMetricsCalculator
...
from rv_android_core.tools.tool_factory import ToolFactory
...
class TestExecutor:
    ...
    def _configure_tool(self, tool_config: ToolConfiguration, static_data: Optional[StaticAnalysisData]) -> AbstractTool:
        ...
        from rv_android_core.llm.data_structures import MCPConfiguration
    ...
    def _create_task(self, 
        ...
        """
        from rv_android_core.experiment.task.task_model import TaskConfiguration
