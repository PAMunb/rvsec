...
class TestVerifyPhaseD:
    def test_all_checks_pass(self, tmp_path):
        """Complete micro calibration with 37 params passes."""
        results_dir = tmp_path / "micro"
        # 37 parameters (11 macro + 26 micro)
        params = {f"param_{i}": float(i) for i in range(37)}
    ...
    def test_wrong_parameter_count(self, tmp_path):
        """Fewer than 37 parameters fails."""
        results_dir = tmp_path / "micro"
