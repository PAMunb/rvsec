...
from rv_screen_parser.screenshot.screenshot_analyzer import ScreenshotAnalyzer, ScreenshotAnalysisResult
...
class TestScreenshotAnalyzer:
    ...
    def test_init_with_image_path(self, mock_image_path):
        ...
        with patch('rv_screen_parser.screenshot.screenshot_analyzer.ScreenshotAnalyzer.analyze') as mock_analyze:
