...
from rv_agent.prompts import v8 as current_prompt  # v8 = form intelligence + spinner guidance + pre-submit validation
...
class RVAgent:
    ...
    def __init__(
        ...
        llm_base = ChatOllama(
            model="qwen-vision-tools-v2",  # Vision + Tools template with JSON parser support
