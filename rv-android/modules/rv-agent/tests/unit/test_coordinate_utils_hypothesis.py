...
class TestCoordinateUtilsHypothesis:
    ...
    def test_device_to_optimized_bounds(self, x, y):
        ...
        opt_x, opt_y = coordinate_utils.device_to_optimized(
            x, y, DEVICE_DIMS, OPTIMIZED_DIMS
        )
    ...
    def test_roundtrip_conversion_is_close(self, x, y):
        ...
        roundtrip_x, roundtrip_y = coordinate_utils.optimized_to_device(
            opt_x, opt_y, DEVICE_DIMS, OPTIMIZED_DIMS
        )
    ...
    def test_bounds_conversion_center_is_consistent(self, x1, y1, x2, y2):
        ...
        center_opt = coordinate_utils.calculate_center_optimized(
            device_bounds, DEVICE_DIMS, OPTIMIZED_DIMS
        )
