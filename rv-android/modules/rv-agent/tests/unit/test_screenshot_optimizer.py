...
class TestScreenshotOptimizer:
    ...
    def test_optimize_custom_settings(self, optimizer, temp_image):
        ...
        low_q_str = optimizer.optimize(str(temp_image), target_size=(100, 100), quality=10)
        
        # Using higher quality
        high_q_str = optimizer.optimize(str(temp_image), target_size=(100, 100), quality=90)
    ...
    def test_optimize_handles_general_exception(self, mock_open, optimizer, temp_image, caplog):
    ...
    def test_optimize_with_fallback_success_path(self, optimizer, temp_image):
        ...
        with patch.object(optimizer, 'optimize', return_value="optimized_string") as mock_optimize:
