...
class TestDeviceInterface:
    ...
    def device_interface(self, mock_ui_adapter, mock_logging_manager):
        ...
        with patch(
            "rv_agent.agent.device_interface.RVAgentConstants"
        ) as mock_constants:
            mock_constants.DEFAULT_DEVICE_ID = "emulator-5554"
            return DeviceInterface(device_id="emulator-5554")

    def test_initialization_with_valid_emulator_id(
        self, mock_ui_adapter, mock_logging_manager
    ):
    ...
    def test_initialization_with_localhost_device_id(
        self, mock_ui_adapter, mock_logging_manager
    ):
    ...
    def test_is_emulator_device_with_emulator_prefix(self):
        ...
        device = DeviceInterface.__new__(
            DeviceInterface
    ...
    def test_get_screen_size_success(self, device_interface, mock_ui_adapter):
        ...
        mock_ui_adapter.device.info = {"displayWidth": 1080, "displayHeight": 1920}
    ...
    def test_get_screen_size_with_missing_values(
        self, device_interface, mock_ui_adapter
    ):
    ...
    def test_get_screen_size_exception(self, device_interface, mock_ui_adapter):
        ...
        type(mock_ui_adapter.device).info = PropertyMock(
