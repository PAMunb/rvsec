...
Note: Task-related interfaces (ITask, ITaskConfiguration, ITaskResult, ITaskFactory) 
have been removed in favor of concrete implementations. Only component and executor 
interfaces remain as they are needed for dependency injection.
"""
