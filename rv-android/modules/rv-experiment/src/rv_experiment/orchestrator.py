...
class ExperimentOrchestrator:
    ...
    def _create_experiment_controller(self) -> ExperimentController:
        ...
        """
        try:
            # Create controller with our event bus
            controller = ExperimentController(event_bus=self.event_bus)
            
            # Configure controller with our settings
            controller.results_dir = self.config.output_dir
            controller.experiment_id = self.config.experiment_id
