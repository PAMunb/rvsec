...
class TestValidation:
    ...
    def test_empty_tool_configs_detected(self, tmp_apk_dir):
        ...
        config = make_valid_config(tmp_apk_dir, tool_configs=[])
    ...
    def test_negative_timeout_detected(self, tmp_apk_dir):
        ...
        config = make_valid_config(tmp_apk_dir, timeouts=[-1])
    ...
    def test_empty_timeouts_detected(self, tmp_apk_dir):
        ...
        config = make_valid_config(tmp_apk_dir, timeouts=[])
    ...
    def test_nonexistent_apk_dir_detected(self):
        ...
        config = make_valid_config("/nonexistent/path/to/apks")
    ...
    def test_empty_apk_dir_detected(self, tmp_path):
        ...
        empty_dir.mkdir()
        config = make_valid_config(str(empty_dir))
    ...
    def test_invalid_spec_set_detected(self, tmp_apk_dir):
        ...
        config = make_valid_config(tmp_apk_dir, specification_set="invalid_set")
