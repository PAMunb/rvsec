...
def post_processor(temp_results_dir):
    ...
    with patch("rv_experiment.experiment.workflow.post_processor.ResultManager"):
        with patch(
            "rv_experiment.experiment.workflow.post_processor.TaskStorage"
        ) as mock_storage:
...
class TestGenerateInstrumentationErrors:
    ...
    def test_generate_instrumentation_errors_creates_result_manager(
        self, temp_results_dir
    ):
        """Test that ResultManager is created with correct parameters."""
        with patch(
            "rv_experiment.experiment.workflow.post_processor.ResultManager"
        ) as mock_rm:
    ...
    def test_generate_instrumentation_errors_calls_generate_reports(
        self, temp_results_dir
    ):
...
class TestGenerateCompletionDiagnostics:
    ...
    def test_generate_completion_diagnostics_creates_file(
        self, post_processor, temp_results_dir
    ):
    ...
    def test_generate_completion_diagnostics_content(
        self, post_processor, temp_results_dir
    ):
    ...
    def test_generate_completion_diagnostics_results_dir(
        self, post_processor, temp_results_dir
    ):
    ...
    def test_generate_completion_diagnostics_handles_exception(self, post_processor):
        ...
        post_processor._save_diagnostics = MagicMock(
...
class TestHelperMethods:
    ...
    def test_save_diagnostics_handles_exception(self, post_processor):
        ...
        # Should not raise
        post_processor._save_diagnostics(
