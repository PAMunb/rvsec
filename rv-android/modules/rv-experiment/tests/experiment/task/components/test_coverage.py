...
from rv_experiment.experiment.task.components.coverage import CoverageComponent
...
def test_initialize_tracker_success(coverage_component, mock_task):
    with patch('rv_experiment.experiment.task.components.coverage.CoverageTracker') as mock_tracker_cls:
        mock_tracker = Mock()
