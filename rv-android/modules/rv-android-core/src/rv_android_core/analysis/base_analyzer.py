...
class BaseAnalyzer(Generic[T], ABC):
    ...
    def __init__(
        self, analyzer_name: str, static_data: Optional[StaticAnalysisData] = None
    ):
        """
        ...
        self.logger = self.logging_manager.get_logger(
            f"analysis.{analyzer_name}", {CONTEXT_COMPONENT: self.__class__.__name__}
        )
...
class BaseRepository:
    ...
    def __init__(self, repository_name: str):
        ...
        self.logging_manager = LoggingManager.get_instance()
        self.logger = self.logging_manager.get_logger(
            f"analysis.{repository_name}", {CONTEXT_COMPONENT: self.__class__.__name__}
        )
