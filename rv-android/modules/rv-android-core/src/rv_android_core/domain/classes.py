...
@validated_model(['class_name', 'name', 'params', 'signature', 'reachable', 'reaches_mop', 'directly_reaches_mop'])
class Method(BaseValidatedModel):
    ...
    class_name: str = Field(
        ...,
        description="Name of the class containing this method",
        min_length=1
    )
    ...
    params: List[str] = Field(
        ...
        description="List of parameter type names"
    )
    
    signature: str = Field(
        ...,
        description="Full method signature for unique identification",
        min_length=1
    )
...
class Clazz(BaseValidatedModel):
    ...
    is_activity: bool = Field(
        default=False,
        description="Whether the class is an Android Activity"
    )
    ...
    methods: Set[Method] = Field(
        default_factory=set,
        description="Set of methods defined in this class"
    )
    
    fields: Set[str] = Field(
        default_factory=set,
        description="Set of field names defined in this class"
    )
    ...
    def get_analysis_summary(self) -> Dict[str, any]:
        ...
        return {
            ...
            'methods': {
                ...
                'reachability_percentage': (reachable_methods / total_methods * 100) if total_methods > 0 else 0
            }
        }
