...
class TestRecoveryStrategies:
    ...
    def test_handle_adb_error_success(self):
        ...
        with patch('rv_android_core.util.error.recovery_strategies.Command') as MockCommand:
    ...
    def test_handle_timeout_error_with_process(self):
        ...
        with patch('rv_android_core.util.error.recovery_strategies.os.kill') as mock_kill:
    ...
    #     with patch('rv_android_core.util.error.recovery_strategies.logging') as mock_logging:
    #         # Set up mock logger
    ...
    def test_recovery_handler_signature(self, error_type, handler_method):
        ...
        with patch('rv_android_core.util.error.recovery_strategies.logging'), \
                patch('rv_android_core.util.error.recovery_strategies.Command'), \
                patch('rv_android_core.util.error.recovery_strategies.os'):
