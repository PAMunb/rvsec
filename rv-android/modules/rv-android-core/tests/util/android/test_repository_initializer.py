...
import pytest
from rv_android_core.domain.classes import Classes as ClassDetailsContainer
from rv_android_core.domain.classes import Clazz as ClassDetails
from rv_android_core.domain.classes import Method as MethodDetails
...
def mock_static_data():
    ...
    return StaticAnalysisData(
        classes=class_container, windows=Windows(), wtg=WindowTransitionGraph()
    )
