...
import pytest
from rv_android_core.util.diagnostics import DiagnosticReport, DiagnosticTool
...
class TestDiagnosticTool:
    ...
    def test_get_system_info_success(
        ...
        with patch("rv_android_core.util.diagnostics.PSUTIL_AVAILABLE", True):
    ...
    def test_get_system_info_psutil_unavailable(self, diagnostic_tool):
        ...
        """
        with patch("rv_android_core.util.diagnostics.PSUTIL_AVAILABLE", False):
            system_info = diagnostic_tool._get_system_info()
    ...
    def test_identify_issues(self, diagnostic_tool):
        ...
        report.experiment_stats = {
            "task_execution": {"avg": 400}  # Longer than 5 minutes
        }
