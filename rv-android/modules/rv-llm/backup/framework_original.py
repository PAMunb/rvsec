...
class PromptFramework:
    ...
    def register_template_directory(self, directory: str) -> None:
        ...
        """
        if self.template_repository and hasattr(self.template_repository, 'register_template_directory'):
            self.template_repository.register_template_directory(directory)
            self.logger.debug(f"Registered template directory: {directory}")
        else:
            self.logger.warning("Template repository does not support directory registration")
    ...
    def register_fragment_directory(self, directory: str) -> None:
        ...
        """
        if self.template_repository and hasattr(self.template_repository, 'register_fragment_directory'):
            self.template_repository.register_fragment_directory(directory)
            self.logger.debug(f"Registered fragment directory: {directory}")
        else:
            self.logger.warning("Template repository does not support directory registration")
