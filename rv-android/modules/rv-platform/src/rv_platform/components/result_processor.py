...
class ResultProcessorComponent:
    ...
    @ErrorHandler.handle_errors(component="ResultProcessorComponent", phase="initialization")
    ...
    @ErrorHandler.handle_errors(component="ResultProcessorComponent", phase="result_processing")
    ...
    @ErrorHandler.handle_errors(component="ResultProcessorComponent", phase="errors_csv_generation")
    ...
    @ErrorHandler.handle_errors(component="ResultProcessorComponent", phase="summary_csv_generation")
    ...
    @ErrorHandler.handle_errors(component="ResultProcessorComponent", phase="results_json_generation")
