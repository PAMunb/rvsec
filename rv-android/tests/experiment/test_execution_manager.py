...
class TestExecutionManager:
    ...
    @pytest.fixture
    def execution_manager(self, mock_storage, mock_event_bus, temp_dir):
    ...
    def test_initialization(self, mock_storage, mock_event_bus):
        ...
        execution_manager = ExecutionManager(mock_storage, mock_event_bus)
    ...
    def test_run_task_success(self, execution_manager, mock_app, mock_tool, temp_dir):
        ...
        with patch('rvandroid.experiment.execution_manager.TaskExecutor', return_value=mock_executor), \
             patch('rvandroid.experiment.execution_manager.StaticAnalysisComponent') as mock_static, \
             patch('rvandroid.experiment.execution_manager.CoverageComponent') as mock_coverage, \
             patch('rvandroid.experiment.execution_manager.EmulatorComponent') as mock_emulator, \
             patch('rvandroid.experiment.execution_manager.LogcatComponent') as mock_logcat, \
             patch('rvandroid.experiment.execution_manager.ToolExecutionComponent') as mock_tool_exec:
    ...
    def test_run_task_execution_error(self, execution_manager, mock_app, mock_tool, temp_dir):
        ...
        with patch('rvandroid.experiment.execution_manager.TaskExecutor', return_value=mock_executor), \
             patch('rvandroid.experiment.execution_manager.StaticAnalysisComponent'), \
             patch('rvandroid.experiment.execution_manager.CoverageComponent'), \
             patch('rvandroid.experiment.execution_manager.EmulatorComponent'), \
             patch('rvandroid.experiment.execution_manager.LogcatComponent'), \
             patch('rvandroid.experiment.execution_manager.ToolExecutionComponent'):
    ...
    @patch('rvandroid.experiment.execution_manager.os')
    @patch('rvandroid.experiment.execution_manager.shutil')
