...
class TestTaskStorage:
    ...
    def sample_task(self):
        ...
        with patch('rvandroid.experiment.task.task_model.LoggingManager', None):
            task = Task(config)
            return task
    ...
    def test_save_new_file(self, storage_file, sample_task):
        ...
        with patch('rvandroid.experiment.task.storage.LoggingManager') as mock_logging, \
             patch('rvandroid.experiment.task.storage.TaskFactory') as mock_factory:
