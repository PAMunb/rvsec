...
class TestApp:
    ...
    def test_app_initialization(self, sample_app_path, mock_apk):
        ...
        with patch('rvandroid.app.APK', return_value=mock_apk) as mock_apk_class:
    ...
    def test_app_initialization_with_absolute_path(self, mock_apk):
        ...
        with patch('rvandroid.app.APK', return_value=mock_apk), \
    ...
    def test_app_initialization_with_empty_path(self):
        ...
        with patch('rvandroid.app.APK', side_effect=Exception("Invalid APK")), \
