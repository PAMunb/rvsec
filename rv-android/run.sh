...
##### APK=apks/26-29-app.zeusln.zeus_25.apk
#APK=ademar.bitac_5.apk --> dex2jar: java.lang.StringIndexOutOfBoundsException: String index out of range: -2
#APK=apks/com.btcontract.wallet_86.apk # --> instrumenting: GC overhead limit
...
#_____APK=apks/com.gaurav.avnc_14.apk # --> dex2jar: java.lang.StringIndexOutOfBoundsException: String index out of range: 44
...
#APK=apks/com.vecturagames.android.app.passwordgenerator_35.apk # --> instrumenting: Type 'kotlin.jvm.functions.Function3' (no debug info available) [error] Mismatch when building parameterization map...
...
#APK=apks/protect.rentalcalc_6.apk
##### APK=ru.valle.btc_260.apk
##### APK=threads.server_272.apk
#APK=apks/xyz.hisname.fireflyiii_112.apk #-->  instrumenting: Type 'kotlin.jvm.functions.Function3' (no debug info available) [error] Mismatch when building parameterization map...
