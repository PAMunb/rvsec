...
def tutorial_section_2():
    ...
    print(
        bank_state["ui_elements"][:200] + "..." if len(bank_state["ui_elements"]) > 200 else bank_state["ui_elements"])
    ...
    try:
        ...
        print(
            "Nota: Em um ambiente de produção, certifique-se de que todos os templates necessários estão disponíveis.")
...
""")
    ...
    try:
        ...
        print("Papel: system")
        print(
            "Conteúdo: Você é um assistente de teste de aplicativo Android especializado em análise de segurança e teste de interface.\n")
        print("Papel: user")
        print(
            "Conteúdo: Analise a tela de login e sugira ações de teste relevantes para validação de entrada e segurança.")
