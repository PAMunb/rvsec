...
with Jinja2 templating engine, providing variable substitution, conditional
sections, and fragment inclusion.
"""
...
class Jinja2Template:
    ...
    This implementation leverages Jinja2's powerful template engine while
    maintaining compatibility with the XML-based template structure.
    """
    ...
    def render(self, data: Dict[str, Any], external_fragments: Optional[Dict[str, str]] = None) -> str:
        ...
        try:
            ...
            if external_fragments is not None:
                ...
                self.logger.debug(f"Updated fragment repository: {prev_count} → {len(self.fragment_repository)} fragments")
...
class FragmentDictLoader(jinja2.BaseLoader):
    ...
    This loader is designed to work with our fragment repository system,
    providing both direct access and simplified namespace resolution.
    """
