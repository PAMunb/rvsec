            ...
            if fragment_name in self.fragments:
                ...
                for variation in possible_variations:
                    if variation in self.fragments:
                        ...
                        self.logger.info(
                            f"Mapped critical fragment from '{variation}' to canonical name '{fragment_name}'")
                        break
                ...
                if filename.endswith(".xml"):
                    ...
                    try:
                        ...
                        if fragment_content:
                            ...
                            common_suffixes = ["_format", "_instructions", "_guidelines", "_base", "_fragment",
                                               "_template"]
                            ...
                            for prefix in common_prefixes:
                                ...
                                if fragment_name_clean.startswith(prefix) or fragment_name_clean.startswith(
                                        prefix_space):
                            ...
                            if len(fragment_keys) <= 20:
                                ...
                                self.logger.debug(
                                    f"First 20 keys for '{fragment_name_clean}': {sorted(fragment_keys)[:20]}...")
                        else:
        ...
        try:
            ...
            for fragment_name in fragments_to_ensure:
                ...
                if fragment_name in self.fragments:
                    ...
                    if alternatives:
                        self.logger.debug(
                            f"Found {len(alternatives)} alternatives for '{fragment_name}': {alternatives[:3]}")
