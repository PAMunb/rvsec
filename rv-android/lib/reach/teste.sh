...
OUT="/home/pedro/tmp/rvsec-reach.csv"
...
echo "[+] Executing ..."
java -jar rvsec-reach.jar --android-dir $ANDROID_PLATFORMS_DIR --mop-dir $MOP_SPECS_DIR --rt-jar $RT_JAR --output $OUT --gesda $GESDA_FILE --writer $WRITER --apk $APK
