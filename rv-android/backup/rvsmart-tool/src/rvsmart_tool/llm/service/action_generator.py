...
class GeneratedAction:
    ...
    def __init__(self, 
        ...
        """
        from rvsmart_tool.constants import ACTION_TYPE_CLICK
...
class ActionGenerator:
    ...
    def __init__(self, config: LLMConfig, static_data: Optional[StaticAnalysisData] = None):
        ...
        self.logger = logging_manager.get_logger(
            "rvsmart_tool.llm.service.action_generator",
    ...
    def _process_custom_parameters(self, action_type: str, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        from rvsmart_tool.constants import ACTION_TYPE_SET_TEXT, ACTION_TYPE_TEXT_CHANGE
