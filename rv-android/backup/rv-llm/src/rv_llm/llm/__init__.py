...
from .data_structures import LLMMessage, LLMRole
...
def register_models():
    ...
    from .ollama_llm import register as register_ollama
    from .huggingface_llm import register as register_huggingface
