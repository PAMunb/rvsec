...
class LLMActionService:
    ...
    def process_state(self, state: Dict[str, Any]):
        ...
        with self.performance_monitor.measure_time("process_state"):
            try:
                ...
                # TODO nao estamos coletando metricas sobre os erros?
                ...
                # TODO vamos padronizar a ordem dos parametros (como acima)
    ...
    def get_configuration_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "server_port": self.tool_config.server_port, # TODO tool_config nao possui atributo
    ...
    def _pre_process_state_stateless(self, state: Dict[str, Any]) -> bool:
        ...
        # TODO IDE identificou duplicacao de codigo a partir daqui
    ...
    def _compress_iteration(self, iteration: Dict[str, Any]) -> Dict[str, Any]:
        ...
        compressed = {
            ...
            "actions_executed": [
                {
                    ...
                    "target": action.get("target", "unknown") # TODO verificar se o target esta sendo corretamente (o que vamos colocar? texto do ItemAction, texto do screenitem, id (do dom) do screenitem (essa ordem de fallbak?))
                }
            ...
            "coverage_progress": {
                ...
                # TODO os mais importantes sao method_cov e mop_method_cov
            }
            # TODO colocar a quantidade de erros mop detectados ... erros unicos
        }
