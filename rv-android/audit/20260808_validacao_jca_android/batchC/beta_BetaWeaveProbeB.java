...
/**
 * Batch B weave probe: drives the PRODUCTION dexlib2 pipeline exactly as
...
public class BetaWeaveProbeB {
    ...
    private static DexFile buildDex(List<Scenario> scenarios) {
        ...
        for (Scenario s : scenarios) {
            ...
            int argWidth = s.params().stream().mapToInt(BetaWeaveProbeB::width).sum();
