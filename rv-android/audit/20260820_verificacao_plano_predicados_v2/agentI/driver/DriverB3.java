...
import mop.IvChainFsmNoLoopSpecRuntimeMonitor;
...
public class DriverB3 {
    public static void main(String[] args) throws Exception {
        ...
        IvChainFsmNoLoopSpecRuntimeMonitor.IvChainFsmNoLoopSpec_genEvent(sr, iv1);
        IvChainFsmNoLoopSpecRuntimeMonitor.IvChainFsmNoLoopSpec_mkEvent(iv1, spec1);
        IvChainFsmNoLoopSpecRuntimeMonitor.IvChainFsmNoLoopSpec_useEvent(spec1, c1);
        ...
        IvChainFsmNoLoopSpecRuntimeMonitor.IvChainFsmNoLoopSpec_mkEvent(iv2, spec2);
        IvChainFsmNoLoopSpecRuntimeMonitor.IvChainFsmNoLoopSpec_useEvent(spec2, c2);
        ...
        IvChainFsmNoLoopSpecRuntimeMonitor.IvChainFsmNoLoopSpec_useEvent(spec3, c3);
