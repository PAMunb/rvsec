...
import mop.IvChainSpecRuntimeMonitor;
...
public class DriverB {
    public static void main(String[] args) throws Exception {
        ...
        IvChainSpecRuntimeMonitor.IvChainSpec_genEvent(sr, iv1);
        IvChainSpecRuntimeMonitor.IvChainSpec_mkEvent(iv1, spec1);
        IvChainSpecRuntimeMonitor.IvChainSpec_useEvent(spec1, c1);
        ...
        IvChainSpecRuntimeMonitor.IvChainSpec_mkEvent(iv2, spec2);
        IvChainSpecRuntimeMonitor.IvChainSpec_useEvent(spec2, c2);
        ...
        IvChainSpecRuntimeMonitor.IvChainSpec_useEvent(spec3, c3);
