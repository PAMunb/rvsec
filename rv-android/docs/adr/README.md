...
| 0006 | [Fixed emulator execution profile: no GPU, no persisted state, cold boot per task; env-parameterized boot budget](0006-emulator-execution-profile-cold-boot-no-gpu.md) | Proposed (gh92) |
