...
**Data**: 2026-02-02
**Status**: Plano aprovado - Implementacao em andamento
...
### Parametros Micro (Fase 2 - 16 params)
...
| navbar_y_percent | 0.94 | 0.90-0.98 |
| statusbar_y_percent | 0.05 | 0.02-0.10 |
...
export CALIBRATION_DATASET="results/cli_experiment_20260201_122731_f9e9f5a4/instrumented_apks"
...
### Fase B: Comparacao Baseline (8-10 horas)
```bash
...
### Fase D: Calibracao Micro (12-24 horas)
```bash
# Usar apenas CALIBRATION_SET (10 APKs) - NAO usar hold-out set
poetry run python -m rv_agent_validation calibrate \
  --apks-dir $CALIBRATION_DATASET \
...
### Fase E: Validacao Final (8-10 horas)
```bash
...
| Implementacao | 2-3 dias | Mudancas de codigo (Tasks 1-4, 6) | ⏳ Pendente |
| Baseline | 1 dia | Executar comparacao APE/FastBot | ⏳ Pendente |
| Calibracao Macro | 2-3 dias | 50 trials em params macro | ⏳ Pendente |
| Calibracao Micro | 1-2 dias | 30 trials em params micro | ⏳ Pendente |
| Validacao | 1 dia | Comparacao final | ⏳ Pendente |
| **Total** | **7-10 dias** | | |
...
- [ ] 3.2 Testar passagem de parametros via DSL
...
- [ ] 6.2 Teste de integracao (1 trial com parametro customizado)
- [ ] 6.3 Smoke test (3 trials em 2 APKs)
