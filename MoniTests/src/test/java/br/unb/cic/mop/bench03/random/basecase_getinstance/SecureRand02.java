package br.unb.cic.mop.bench03.random.basecase_getinstance;
import java.nio.charset.StandardCharsets;
import java.security.NoSuchAlgorithmException;
import java.security.SecureRandom;

public class SecureRand02 {
    public static void main(String[] args) throws NoSuchAlgorithmException {
        ...
        // If setSeed is not called, the first call to nextBytes will
        // force the SecureRandom object to seed itself. This self-seeding
