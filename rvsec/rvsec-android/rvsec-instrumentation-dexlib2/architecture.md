...
(`artifactId rvsec-instrumentation-dexlib2`, version `0.9.1-SNAPSHOT`), packaged as a single
...
(`rvsec-instrumentation-dexlib2`, `0.9.1-SNAPSHOT`) packaged as a single fat JAR named
