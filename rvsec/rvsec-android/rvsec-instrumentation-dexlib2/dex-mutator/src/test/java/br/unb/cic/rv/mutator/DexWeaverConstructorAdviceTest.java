...
/**
 * gh52 §5.13(a): inline {@code after() returning} advice on constructor invokes.
 *
 ...
 * hook, and the constructed object is the {@code returning} binding (no
 * wrapper, since a wrapper would have to allocate-and-construct, changing
 * call-site semantics). The plain {@code after} shape, which also runs on the
 * exceptional path, is covered by {@link DexWeaverCtorAfterFinallyTest}.
 */
