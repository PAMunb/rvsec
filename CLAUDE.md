...
## Purpose
Root Maven reactor (`br.unb.cic:rvsec-parent:0.9.4-SNAPSHOT`, packaging `pom`) that builds RVSEC's Java side end to end: monitor generation tooling, the MOP build-time plugin, and the JSE/Android agent modules.
